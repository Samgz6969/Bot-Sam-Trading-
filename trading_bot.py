...
class Config:
    ...
    poll_seconds: int = 5            # Cada cuanto revisa el mercado cada moneda (segundos)
    ...
    telegram_summary_every_n_cycles: int = 360  # resumen periodico por moneda (~cada 30 min con poll de 5s)
...
<body>
  ...
  <div class="subtitle">Paper trading &middot; datos reales de Binance &middot; se actualiza solo cada 2s</div>
