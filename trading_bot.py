...
# mensaje consolidado de "conexion exitosa" en vez de 6 mensajes sueltos.
...
def _report_startup_result(symbol: str, ok: bool):
    ...
    if remaining == 0 and notifier is not None:
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                self.log.error(f"[{self.symbol}] Fallo el refresco de precio: {e}")
